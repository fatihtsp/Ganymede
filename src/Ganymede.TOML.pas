...
type
  ...
  { TGnyTomlValue }
  TGnyTomlValue = record
  private
    FKind:          TGnyTomlValueKind;
    FStringValue:   string;
    FIntegerValue:  Int64;
    FFloatValue:    Double;
    FBooleanValue:  Boolean;
    FDateTimeValue: TDateTime;
    FArrayValue:    TGnyTomlArray;
    FTableValue:    TGnyToml;
  public
    class function CreateNone(): TGnyTomlValue; static;
    class function CreateString(const AValue: string): TGnyTomlValue; static;
    class function CreateInteger(const AValue: Int64): TGnyTomlValue; static;
    class function CreateFloat(const AValue: Double): TGnyTomlValue; static;
    class function CreateBoolean(const AValue: Boolean): TGnyTomlValue; static;
    class function CreateDateTime(const AValue: TDateTime): TGnyTomlValue; static;
    class function CreateDate(const AValue: TDateTime): TGnyTomlValue; static;
    class function CreateTime(const AValue: TDateTime): TGnyTomlValue; static;
    class function CreateArray(const AValue: TGnyTomlArray): TGnyTomlValue; static;
    class function CreateTable(const AValue: TGnyToml): TGnyTomlValue; static;

    property Kind: TGnyTomlValueKind read FKind;
    ...
    function AsArray(): TGnyTomlArray;
    function AsTable(): TGnyToml;
  ...
  TGnyTomlArray = class
  private
    FItems: TList<TGnyTomlValue>;
    function GetCount(): Integer;
    function GetItem(const AIndex: Integer): TGnyTomlValue;
  public
    constructor Create();
    destructor Destroy(); override;

    procedure Add(const AValue: TGnyTomlValue);
    ...
    property Items[const AIndex: Integer]: TGnyTomlValue read GetItem; default;
  end;

  { TGnyTomlParseError }
  TGnyTomlParseError = class(Exception)
  private
    FLine:   Integer;
    FColumn: Integer;
  public
  ...
  TGnyToml = class
  private
    FValues:         TDictionary<string, TGnyTomlValue>;
    FOwnedTables:    TObjectList<TGnyToml>;
    FOwnedArrays:    TObjectList<TGnyTomlArray>;
    ...
    FLength:         Integer;
    FLastError:      string;
    FCurrentTable:   TGnyToml;
    FImplicitTables: TDictionary<string, TGnyToml>;
    FDefinedTables:  TDictionary<string, Boolean>;
    FArrayTables:    TDictionary<string, TGnyTomlArray>;
    ...
    procedure ParseKeyValue(const ATable: TGnyToml);
    ...
    function  ParseValue(): TGnyTomlValue;
    function  ParseNumberOrDateTime(): TGnyTomlValue;
    function  ParseInteger(const AText: string): Int64;
    function  ParseFloat(const AText: string): Double;
    function  ParseDateTime(const AText: string): TGnyTomlValue;
    function  ParseArray(): TGnyTomlArray;
    function  ParseInlineTable(): TGnyToml;
    ...
    function  GetOrCreateTablePath(const APath: TArray<string>;
      const AImplicit: Boolean): TGnyToml;
    function  GetOrCreateArrayTablePath(
      const APath: TArray<string>): TGnyToml;
    procedure SetValueAtPath(const ATable: TGnyToml;
      const APath: TArray<string>; const AValue: TGnyTomlValue);
    function  PathToString(const APath: TArray<string>): string;

  public
    // Ownership
    function CreateOwnedTable(): TGnyToml;
    function CreateOwnedArray(): TGnyTomlArray;

    constructor Create();
    destructor Destroy(); override;

    // Parsing
    class function FromFile(const AFilename: string): TGnyToml;
    class function FromString(const ASource: string): TGnyToml;
    function Parse(const ASource: string): Boolean;
    function GetLastError(): string;

    // Value access
    function  TryGetValue(const AKey: string;
      out AValue: TGnyTomlValue): Boolean;
    ...
    function GetOrCreateTable(const AKey: string): TGnyToml;
    function GetOrCreateArray(const AKey: string): TGnyTomlArray;
    function GetTable(const AKey: string): TGnyToml;
    function GetArray(const AKey: string): TGnyTomlArray;
    ...
    procedure SetValue(const AKey: string; const AValue: TGnyTomlValue);
...
class function TGnyTomlValue.CreateNone(): TGnyTomlValue;
begin
  Result       := Default(TGnyTomlValue);
  Result.FKind := tvkNone;
end;

class function TGnyTomlValue.CreateString(
  const AValue: string): TGnyTomlValue;
begin
  Result              := Default(TGnyTomlValue);
...
class function TGnyTomlValue.CreateInteger(
  const AValue: Int64): TGnyTomlValue;
begin
  Result               := Default(TGnyTomlValue);
...
class function TGnyTomlValue.CreateFloat(
  const AValue: Double): TGnyTomlValue;
begin
  Result             := Default(TGnyTomlValue);
...
class function TGnyTomlValue.CreateBoolean(
  const AValue: Boolean): TGnyTomlValue;
begin
  Result               := Default(TGnyTomlValue);
...
class function TGnyTomlValue.CreateDateTime(
  const AValue: TDateTime): TGnyTomlValue;
begin
  Result                := Default(TGnyTomlValue);
...
class function TGnyTomlValue.CreateDate(
  const AValue: TDateTime): TGnyTomlValue;
begin
  Result                := Default(TGnyTomlValue);
...
class function TGnyTomlValue.CreateTime(
  const AValue: TDateTime): TGnyTomlValue;
begin
  Result                := Default(TGnyTomlValue);
...
class function TGnyTomlValue.CreateArray(
  const AValue: TGnyTomlArray): TGnyTomlValue;
begin
  Result             := Default(TGnyTomlValue);
...
class function TGnyTomlValue.CreateTable(
  const AValue: TGnyToml): TGnyTomlValue;
begin
  Result             := Default(TGnyTomlValue);
...
function TGnyTomlValue.AsString(): string;
begin
...
function TGnyTomlValue.AsInteger(): Int64;
begin
...
function TGnyTomlValue.AsFloat(): Double;
begin
...
function TGnyTomlValue.AsBoolean(): Boolean;
begin
...
function TGnyTomlValue.AsDateTime(): TDateTime;
begin
...
function TGnyTomlValue.AsArray(): TGnyTomlArray;
begin
...
function TGnyTomlValue.AsTable(): TGnyToml;
begin
...
function TGnyTomlValue.IsNone(): Boolean;
begin
  Result := FKind = tvkNone;
end;
...
constructor TGnyTomlArray.Create();
begin
  inherited;
  FItems := TList<TGnyTomlValue>.Create();
end;

destructor TGnyTomlArray.Destroy();
begin
  FItems.Free();
  inherited;
end;

function TGnyTomlArray.GetCount(): Integer;
begin
  Result := FItems.Count;
end;

function TGnyTomlArray.GetItem(const AIndex: Integer): TGnyTomlValue;
begin
  Result := FItems[AIndex];
end;

procedure TGnyTomlArray.Add(const AValue: TGnyTomlValue);
begin
  FItems.Add(AValue);
end;

procedure TGnyTomlArray.AddString(const AValue: string);
begin
  FItems.Add(TGnyTomlValue.CreateString(AValue));
end;

procedure TGnyTomlArray.AddInteger(const AValue: Int64);
begin
  FItems.Add(TGnyTomlValue.CreateInteger(AValue));
end;

procedure TGnyTomlArray.AddFloat(const AValue: Double);
begin
  FItems.Add(TGnyTomlValue.CreateFloat(AValue));
end;

procedure TGnyTomlArray.AddBoolean(const AValue: Boolean);
begin
  FItems.Add(TGnyTomlValue.CreateBoolean(AValue));
end;

procedure TGnyTomlArray.Clear();
begin
  FItems.Clear();
end;
...
constructor TGnyTomlParseError.Create(const AMessage: string;
...
constructor TGnyToml.Create();
begin
  inherited;
  FValues         := TDictionary<string, TGnyTomlValue>.Create();
  FOwnedTables    := TObjectList<TGnyToml>.Create(True);
  FOwnedArrays    := TObjectList<TGnyTomlArray>.Create(True);
...
class function TGnyToml.FromFile(const AFilename: string): TGnyToml;
var
  LSource: string;
begin
  if not TFile.Exists(AFilename) then
    raise TGnyTomlParseError.Create('File not found: ' + AFilename, 0, 0);

  LSource := TFile.ReadAllText(AFilename, TEncoding.UTF8);
  Result  := FromString(LSource);
end;

class function TGnyToml.FromString(const ASource: string): TGnyToml;
begin
  Result := TGnyToml.Create();
  try
    if not Result.Parse(ASource) then
      raise TGnyTomlParseError.Create(Result.GetLastError(),
...
function TGnyToml.Parse(const ASource: string): Boolean;
begin
  FSource       := ASource;
  FPos          := 1;
  FLine         := 1;
  ...
  FImplicitTables := TDictionary<string, TGnyToml>.Create();
  FDefinedTables  := TDictionary<string, Boolean>.Create();
  FArrayTables    := TDictionary<string, TGnyTomlArray>.Create();

  try
    Result := ParseDocument();
  except
    on E: TGnyTomlParseError do
    begin
...
function TGnyToml.GetLastError(): string;
begin
  Result := FLastError;
end;
...
function TGnyToml.IsEOF(): Boolean;
begin
  Result := FPos > FLength;
end;

function TGnyToml.Peek(const AOffset: Integer): Char;
var
  LIndex: Integer;
begin
  LIndex := FPos + AOffset;
...
procedure TGnyToml.Advance(const ACount: Integer);
var
  LI: Integer;
begin
...
procedure TGnyToml.SkipWhitespace();
begin
  while not IsEOF() and IsWhitespace(Peek()) do
    Advance();
end;

procedure TGnyToml.SkipWhitespaceAndNewlines();
begin
  while not IsEOF() do
  begin
...
procedure TGnyToml.SkipToEndOfLine();
begin
  while not IsEOF() and not IsNewline(Peek()) do
    Advance();
end;

function TGnyToml.IsNewline(const ACh: Char): Boolean;
begin
  Result := (ACh = #10) or (ACh = #13);
end;

function TGnyToml.IsWhitespace(const ACh: Char): Boolean;
begin
  Result := (ACh = ' ') or (ACh = #9);
end;

function TGnyToml.IsBareKeyChar(const ACh: Char): Boolean;
begin
  Result := CharInSet(ACh, ['A'..'Z', 'a'..'z', '0'..'9', '_', '-']);
end;

function TGnyToml.IsDigit(const ACh: Char): Boolean;
begin
  Result := CharInSet(ACh, ['0'..'9']);
end;

function TGnyToml.IsHexDigit(const ACh: Char): Boolean;
begin
  Result := CharInSet(ACh, ['0'..'9', 'A'..'F', 'a'..'f']);
end;

function TGnyToml.IsOctalDigit(const ACh: Char): Boolean;
begin
  Result := CharInSet(ACh, ['0'..'7']);
end;

function TGnyToml.IsBinaryDigit(const ACh: Char): Boolean;
begin
  Result := CharInSet(ACh, ['0', '1']);
end;

function TGnyToml.HexValue(const ACh: Char): Integer;
begin
...
procedure TGnyToml.Error(const AMessage: string);
begin
  raise TGnyTomlParseError.Create(AMessage, FLine, FColumn);
end;
...
function TGnyToml.CreateOwnedTable(): TGnyToml;
begin
  Result := TGnyToml.Create();
  FOwnedTables.Add(Result);
end;

function TGnyToml.CreateOwnedArray(): TGnyTomlArray;
begin
  Result := TGnyTomlArray.Create();
  FOwnedArrays.Add(Result);
end;

// -- Parser methods -----------------------------------------------------------

procedure TGnyToml.CaptureComment();
var
  LStart: Integer;
  LLine:  string;
begin
...
function TGnyToml.ParseDocument(): Boolean;
begin
  Result := True;
...
procedure TGnyToml.ParseExpression();
begin
  SkipWhitespace();
...
procedure TGnyToml.ParseKeyValue(const ATable: TGnyToml);
var
  LKey:   TArray<string>;
  LValue: TGnyTomlValue;
begin
  LKey := ParseKey();
...
function TGnyToml.ParseKey(): TArray<string>;
var
  LParts: TList<string>;
  LKey:   string;
begin
...
function TGnyToml.ParseSimpleKey(): string;
begin
  if Peek() = '"' then
...
function TGnyToml.ParseBasicString(): string;
begin
  if Peek() <> '"' then
    Error('Expected ''"''');
  Advance();
...
function TGnyToml.ParseMultiLineBasicString(): string;
var
...
function TGnyToml.ParseLiteralString(): string;
begin
  if Peek() <> '''' then
    Error('Expected ''''');
  Advance();
...
function TGnyToml.ParseMultiLineLiteralString(): string;
begin
  Result := '';
...
function TGnyToml.ParseEscapeSequence(): string;
var
  LCodePoint: Integer;
  LI:         Integer;
begin
...
function TGnyToml.ParseValue(): TGnyTomlValue;
var
  LCh: Char;
begin
  LCh := Peek();
  ...
  if LCh = '"' then
    Result := TGnyTomlValue.CreateString(ParseBasicString())
  else if LCh = '''' then
    Result := TGnyTomlValue.CreateString(ParseLiteralString())
  else if LCh = '[' then
    Result := TGnyTomlValue.CreateArray(ParseArray())
  else if LCh = '{' then
    Result := TGnyTomlValue.CreateTable(ParseInlineTable())
  else if (LCh = 't') and (Peek(1) = 'r') and (Peek(2) = 'u') and
          (Peek(3) = 'e') and not IsBareKeyChar(Peek(4)) then
  begin
    Advance(4);
    Result := TGnyTomlValue.CreateBoolean(True);
  end
  ...
  begin
    Advance(5);
    Result := TGnyTomlValue.CreateBoolean(False);
  end
  ...
  begin
    Error('Invalid value');
    Result := TGnyTomlValue.CreateNone();
  end;
end;

function TGnyToml.ParseNumberOrDateTime(): TGnyTomlValue;
var
  LStart:    Integer;
  LText:     string;
  LHasColon: Boolean;
...
begin
  ...
  begin
    ...
    begin
      Advance(3);
      Result := TGnyTomlValue.CreateFloat(Infinity);
      Exit;
    end
    else if (Peek() = 'n') and (Peek(1) = 'a') and (Peek(2) = 'n') then
    begin
      Advance(3);
      Result := TGnyTomlValue.CreateFloat(NaN);
      Exit;
    end
    else
      Error('Invalid value');
  ...
  begin
    ...
    begin
      ...
      begin
        Advance(4);
        Result := TGnyTomlValue.CreateFloat(NegInfinity);
        Exit;
      end
  ...
  if LHasColon or (LHasDash and (Length(LText) >= 10)) then
    ...
    Result := TGnyTomlValue.CreateFloat(ParseFloat(LText))
  else
    Result := TGnyTomlValue.CreateInteger(ParseInteger(LText));
end;

function TGnyToml.ParseInteger(const AText: string): Int64;
var
  LText: string;
  LNeg:  Boolean;
  LI:    Integer;
...
function TGnyToml.ParseFloat(const AText: string): Double;
var
...
function TGnyToml.ParseDateTime(const AText: string): TGnyTomlValue;
var
  LText:        string;
  LYear:        Integer;
  LMonth:       Integer;
...
begin
  ...
  if LHasDate and LHasTime then
    Result := TGnyTomlValue.CreateDateTime(LDateTime)
  else if LHasDate then
    Result := TGnyTomlValue.CreateDate(LDateTime)
  else
    Result := TGnyTomlValue.CreateTime(LDateTime);
end;

function TGnyToml.ParseArray(): TGnyTomlArray;
var
  LValue: TGnyTomlValue;
begin
  if Peek() <> '[' then
...
function TGnyToml.ParseInlineTable(): TGnyToml;
var
  LKey:   TArray<string>;
  LValue: TGnyTomlValue;
begin
...
procedure TGnyToml.ParseTableHeader();
var
  LKey:  TArray<string>;
  LPath: string;
begin
...
procedure TGnyToml.ParseArrayTableHeader();
var
  LKey:  TArray<string>;
  LPath: string;
begin
...
function TGnyToml.PathToString(const APath: TArray<string>): string;
var
  LI: Integer;
begin
  Result := '';
...
function TGnyToml.GetOrCreateTablePath(const APath: TArray<string>;
  const AImplicit: Boolean): TGnyToml;
var
  LCurrent:  TGnyToml;
  LI:        Integer;
...
begin
  ...
  begin
    ...
    begin
      ...
      LCurrent.FValues.Add(LKey, TGnyTomlValue.CreateTable(LNewTable));
...
function TGnyToml.GetOrCreateArrayTablePath(
  const APath: TArray<string>): TGnyToml;
var
  LCurrent:  TGnyToml;
  LI:        Integer;
...
begin
  ...
  begin
    ...
    LCurrent.FValues.Add(LKey, TGnyTomlValue.CreateArray(LArray));
    if not LCurrent.FKeyOrder.Contains(LKey) then
      LCurrent.FKeyOrder.Add(LKey);
  ...
  LNewTable := CreateOwnedTable();
  LArray.Add(TGnyTomlValue.CreateTable(LNewTable));

  Result := LNewTable;
end;

procedure TGnyToml.SetValueAtPath(const ATable: TGnyToml;
  const APath: TArray<string>; const AValue: TGnyTomlValue);
var
  LCurrent:  TGnyToml;
  LI:        Integer;
...
function TGnyToml.GetKeyComment(const AKey: string): string;
begin
  if not FKeyComments.TryGetValue(AKey, Result) then
    Result := '';
end;

procedure TGnyToml.SetKeyComment(const AKey: string; const AValue: string);
begin
...
function TGnyToml.TryGetValue(const AKey: string;
  out AValue: TGnyTomlValue): Boolean;
begin
  Result := FValues.TryGetValue(AKey, AValue);
end;

function TGnyToml.ContainsKey(const AKey: string): Boolean;
begin
  Result := FValues.ContainsKey(AKey);
end;

procedure TGnyToml.RemoveKey(const AKey: string);
begin
  FValues.Remove(AKey);
  FKeyOrder.Remove(AKey);
end;

function TGnyToml.GetString(const AKey: string;
  const ADefault: string): string;
var
  LValue: TGnyTomlValue;
begin
...
function TGnyToml.GetInteger(const AKey: string;
...
function TGnyToml.GetFloat(const AKey: string;
...
function TGnyToml.GetBoolean(const AKey: string;
...
function TGnyToml.GetDateTime(const AKey: string;
...
procedure TGnyToml.SetString(const AKey: string; const AValue: string);
begin
  FValues.AddOrSetValue(AKey, TGnyTomlValue.CreateString(AValue));
  if not FKeyOrder.Contains(AKey) then
    FKeyOrder.Add(AKey);
end;

procedure TGnyToml.SetInteger(const AKey: string; const AValue: Int64);
begin
  FValues.AddOrSetValue(AKey, TGnyTomlValue.CreateInteger(AValue));
  if not FKeyOrder.Contains(AKey) then
    FKeyOrder.Add(AKey);
end;

procedure TGnyToml.SetFloat(const AKey: string; const AValue: Double);
begin
  FValues.AddOrSetValue(AKey, TGnyTomlValue.CreateFloat(AValue));
  if not FKeyOrder.Contains(AKey) then
    FKeyOrder.Add(AKey);
end;

procedure TGnyToml.SetBoolean(const AKey: string; const AValue: Boolean);
begin
  FValues.AddOrSetValue(AKey, TGnyTomlValue.CreateBoolean(AValue));
  if not FKeyOrder.Contains(AKey) then
    FKeyOrder.Add(AKey);
end;

procedure TGnyToml.SetDateTime(const AKey: string; const AValue: TDateTime);
begin
  FValues.AddOrSetValue(AKey, TGnyTomlValue.CreateDateTime(AValue));
  if not FKeyOrder.Contains(AKey) then
    FKeyOrder.Add(AKey);
end;

function TGnyToml.GetOrCreateTable(const AKey: string): TGnyToml;
var
  LValue:    TGnyTomlValue;
  LNewTable: TGnyToml;
begin
  ...
  begin
    LNewTable := CreateOwnedTable();
    FValues.Add(AKey, TGnyTomlValue.CreateTable(LNewTable));
    if not FKeyOrder.Contains(AKey) then
      FKeyOrder.Add(AKey);
    Result := LNewTable;
  end;
...
function TGnyToml.GetOrCreateArray(const AKey: string): TGnyTomlArray;
var
  LValue:    TGnyTomlValue;
  LNewArray: TGnyTomlArray;
begin
  if FValues.TryGetValue(AKey, LValue) then
  begin
    if LValue.Kind = tvkArray then
  ...
  begin
    ...
    FValues.Add(AKey, TGnyTomlValue.CreateArray(LNewArray));
    if not FKeyOrder.Contains(AKey) then
      FKeyOrder.Add(AKey);
    Result := LNewArray;
  end;
...
function TGnyToml.GetTable(const AKey: string): TGnyToml;
var
  LValue: TGnyTomlValue;
begin
...
function TGnyToml.GetArray(const AKey: string): TGnyTomlArray;
var
  LValue: TGnyTomlValue;
begin
...
function TGnyToml.GetKeys(): TArray<string>;
begin
  Result := FKeyOrder.ToArray();
end;

function TGnyToml.GetCount(): Integer;
begin
  Result := FValues.Count;
end;

procedure TGnyToml.SetValue(const AKey: string;
  const AValue: TGnyTomlValue);
begin
